...
public class ProductControllerTest {
    ...
    public void createProduct_success() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.productName", equalTo("COCO")))
                .andExpect(jsonPath("$.category", equalTo("CAR")))
                .andExpect(jsonPath("$.price", equalTo(6000)))
                .andExpect(jsonPath("$.stock", equalTo(100)))
                .andExpect(jsonPath("$.imageUrl", equalTo("www.google.com")))
